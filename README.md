...
## Descripción
Tutorial de Android Studio en el que aprenderemos a añadir animaciones a nuestra App con la librería [Lottie](https://github.com/airbnb/lottie-android).

Para ello, veremos cómo hace Twitter para realizar la animación de "Like" y reproduciremos ese comportamiento en Android y Kotlin.

## Videotutorial
[![Cómo AÑADIR ANIMACIONES en Android Studio | Lottie Tutorial](https://img.youtube.com/vi/h3ppaE8fBsQ/0.jpg)](https://youtu.be/h3ppaE8fBsQ)

## Requisitos
* [Android Studio](https://developer.android.com/studio) 4+
* [Lottie](https://github.com/airbnb/lottie-android) 3.4.2
